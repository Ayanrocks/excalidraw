...
export type ExcalidrawCylinderElement = _ExcalidrawElementBase & {
  type: "cylinder";
};

export type ExcalidrawQueueElement = _ExcalidrawElementBase & {
  type: "queue";
};
...
export type ConvertibleGenericTypes = "rectangle" | "diamond" | "ellipse" | "cylinder" | "queue" | "cloud";
